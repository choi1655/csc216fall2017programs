...
public class TrailData implements Data {
     ...
     * 
     * @param trailID to take in
     * @param trailName to take in
     * @param closedForMaintenance to take in
     * @param snow to take in 
     * @param distance to take in
     * @param difficulty to take in
     * @param activities to take in
     */
