...
public class CourseTest {
	...
	public void testCourseStringStringStringIntStringStringIntInt() {
		...
		Course c = null;
		try {
			c = new Course(null, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		...
		c = null;
		try {
			c = new Course("", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course("E11", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course("CSC2167", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
			fail();
		} catch (IllegalArgumentException e) {
			assertNull(c);
		}
		...
		c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
	...
	public void testCourseStringStringStringIntStringString() {
		...
		Course c = null;
		try {
			c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, "A");
			assertEquals(NAME, c.getName());
			assertEquals(TITLE, c.getTitle());
			assertEquals(SECTION, c.getSection());
			assertEquals(CREDITS, c.getCredits());
	...
	public void testSetTitle() {
		Course c = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		assertEquals(NAME, c.getName());
		assertEquals(TITLE, c.getTitle());
		assertEquals(SECTION, c.getSection());
		assertEquals(CREDITS, c.getCredits());
	...
	public void testGetMeetingString() {
		...
		Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		assertEquals("MW 1:30PM-2:45PM", c1.getMeetingString());
		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, 900, 1035);
		assertEquals("MW 9:00AM-10:35AM", c2.getMeetingString());
		Activity c3 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, "A");
		assertEquals("Arranged", c3.getMeetingString());
		Activity c4 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, "TH", 1145, 1425);
	...
	public void testEqualsObject() {
		Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		Activity c3 = new Course(NAME, "Different", SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		Activity c4 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		Activity c5 = new Course(NAME, TITLE, SECTION, 5, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		Activity c6 = new Course(NAME, TITLE, SECTION, CREDITS, "Different", ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		Activity c7 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, "TH", START_TIME, END_TIME);
		Activity c8 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, 830, END_TIME);
		Activity c9 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, 1400);
	...
	public void testToString() {
		Activity c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		String s1 = "CSC216,Programming Concepts - Java,001,4,sesmith5,250,MW,1330,1445";
		assertEquals(s1, c1.toString());
		
		Activity c2 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, "A");
		String s2 = "CSC216,Programming Concepts - Java,001,4,sesmith5,250,A";
		assertEquals(s2, c2.toString());
	}
	
	/**
	 * Test method which checks whether Course is a duplicate of another Activity
	 */
	@Test
	public void testIsDuplicate() {
		// set up objects
		Course c1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		Course c2 = new Course("PB200", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		Activity a1 = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		
		// test nonduplicate activity
		assertFalse(c1.isDuplicate(c2));
		assertFalse(c2.isDuplicate(c1));
		
		// test duplicate activity
		assertTrue(c1.isDuplicate(a1));
		assertTrue(a1.isDuplicate(c1));
	}
	
	/**
	 * Test display array methods to see if they are producing correct output
	 */
	@Test
	public void testDisplayArrays() {
		// set up object
		Course course = new Course(NAME, TITLE, SECTION, CREDITS, INSTRUCTOR_ID, ENROLL, MEETING_DAYS, START_TIME, END_TIME);
		
		// check short display array
		String[] array = course.getShortDisplayArray();
		assertEquals(5, array.length);
		assertEquals(NAME, array[0]);
		assertEquals(SECTION, array[1]);
		assertEquals(TITLE, array[2]);
		assertEquals(MEETING_DAYS + " 1:30PM-2:45PM", array[3]);
		assertEquals(Integer.toString(ENROLL), array[4]);
		
		// check long display array
		array = course.getLongDisplayArray();
		assertEquals(7, array.length);
		assertEquals(NAME, array[0]);
		assertEquals(SECTION, array[1]);
		assertEquals(TITLE, array[2]);
		assertEquals(CREDITS, Integer.parseInt(array[3]));
		assertEquals(INSTRUCTOR_ID, array[4]);
		assertEquals(MEETING_DAYS + " 1:30PM-2:45PM", array[5]);
		assertEquals("", array[6]);
	}
	
	/**
	 * Tests to make sure that compareTo() functions correctly
	 */
	@Test
	public void testCompareTo() {
		Course c1 = new Course("CSC116", "Into to Java", "002", 3, "jdaniels", ENROLL, "MW", 1000, 1100);
		Course c2 = new Course("CSC116", "Into to Java", "002", 3, "jdaniels", ENROLL, "MW", 1000, 1100);
		Course c3 = new Course("CSC116", "Into to Java", "022", 3, "jdaniels", ENROLL, "MW", 1000, 1100);
		Course c4 = new Course("CSC226", "Discrete Math", "201", 3, "dbarns", ENROLL, "TH", 1000, 1100);
