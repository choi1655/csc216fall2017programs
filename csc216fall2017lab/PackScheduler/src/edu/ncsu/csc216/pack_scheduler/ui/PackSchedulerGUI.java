...
/**
 * Main GUI for the PackScheduler project. It controls authentication and
 * manages the panels for each user.
 * 
...
public class PackSchedulerGUI {
	...
	private class LoginPanel extends JPanel implements ActionListener {
		...
		/**
		 * Performs actions when any component with an action listener is
		 * selected.
		 * 
		 * @param e
		 *            ActionEvent representing the user action
		 */
		@Override
	...
	private class RegistrarPanel extends JPanel implements ActionListener {
		...
		public RegistrarPanel() {
			...
			// scrollRPanel = new JScrollPane(rPanel,
	...
	private class FacultyPanel extends JPanel implements ActionListener {
		...
		/**
		 * Temporary class for the FacultyPanel until we implement that
		 * functionality.
		 */
		public FacultyPanel() {
			super(new GridBagLayout());
		 ...
		 */
		public void updateTables() {
			facultySchedulePanel.updateTables();
		}
	}
