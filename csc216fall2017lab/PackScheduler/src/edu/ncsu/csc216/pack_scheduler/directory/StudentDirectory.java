...
public class StudentDirectory {
	...
	/**
	 * Saves all studentcs in the directory to a file.
	 * 
	 * @param fileName
	 *            name of file to save students to.
	 */
	...
	/**
	 * Returns the Student in the studentDirectory with the matching id that is
	...
	public Student getStudentById(String id) {
		Student s = null;
		for (int i = 0; i < studentDirectory.size(); i++) {
			if (studentDirectory != null && studentDirectory.get(i).getId().equals(id)) {
